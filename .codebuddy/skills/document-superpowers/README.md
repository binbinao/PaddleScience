...
```
💡 Brainstorming → 📋 Planning → 🔎 Research (optional) → ✍️ Execution → 🔍 Review
```
...
### Context & Research
- **reference-material** - Reads and extracts context from reference files (txt, markdown, pdf, images) in `docs/reference/`
- **research-gathering** - Search and organize reference materials (articles, images) per section before writing (optional stage between planning and execution)

### Advanced
- **subagent-driven-writing** - Fast iteration with fresh subagent per section and two-stage review

### Tech Doc Enhancement Plugins
- **tech-doc-writing** - Orchestrator plugin for IT technical documentation: adds tech-specific brainstorming questions, 8 document-type templates, and Technical Accuracy review pass
- **tech-doc-code-blocks** - Code block generation with progressive complexity (minimal → production → advanced), syntax validation, and formatting standards
- **tech-doc-mermaid** - Mermaid diagram generation with type selection guide, syntax best practices, and document-type-to-diagram mapping
- **tech-doc-image-search** - Image placeholder management, alt text generation, source recommendations, and visual density guidelines
...
- ~/.claude/skills/document-superpowers/skills/reference-material/SKILL.md
- ~/.claude/skills/document-superpowers/skills/tech-doc-writing/SKILL.md
- ~/.claude/skills/document-superpowers/skills/tech-doc-code-blocks/SKILL.md
- ~/.claude/skills/document-superpowers/skills/tech-doc-mermaid/SKILL.md
- ~/.claude/skills/document-superpowers/skills/tech-doc-image-search/SKILL.md
```
...
- ~/.gemini/skills/document-superpowers/skills/reference-material/SKILL.md
- ~/.gemini/skills/document-superpowers/skills/tech-doc-writing/SKILL.md
- ~/.gemini/skills/document-superpowers/skills/tech-doc-code-blocks/SKILL.md
- ~/.gemini/skills/document-superpowers/skills/tech-doc-mermaid/SKILL.md
- ~/.gemini/skills/document-superpowers/skills/tech-doc-image-search/SKILL.md
```
...
```
docs/
├── reference/                              # Place reference materials here (input)
│   ├── README.md                           # Folder guide
│   ├── *.txt, *.md, *.pdf                  # Text-based references
│   └── *.png, *.jpg, *.gif, *.webp        # Image references
└── writing/                                # Generated writing artifacts (output)
    ├── YYYY-MM-DD-topic-references.md      # Reference summary (if references used)
    ├── YYYY-MM-DD-topic-brief.md           # Approved topic brief
    ├── YYYY-MM-DD-topic-plan.md            # Detailed outline
    ├── YYYY-MM-DD-topic-research.md        # Research materials (optional)
    ├── assets/
    │   └── YYYY-MM-DD-topic/               # Downloaded images (optional)
    ├── drafts/
    │   └── YYYY-MM-DD-topic/
