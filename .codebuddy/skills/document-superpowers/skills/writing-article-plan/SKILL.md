...
After saving the plan, ask about research before offering execution choice:

**"Article plan complete and saved to `docs/writing/<filename>.md`.**

**Before writing, would you like to search and organize reference materials first?**

**1. Yes, research first** - Search for supporting articles, data, and images for each section before writing

**2. No, start writing directly** - Proceed to execution without a dedicated research step

**Which approach?"**

**If Research chosen:**
- **REQUIRED SUB-SKILL:** Use document-superpowers:research-gathering
- Stay in this session
- Research skill will handle the execution handoff after materials are compiled

**If No Research chosen, offer execution choice:**
