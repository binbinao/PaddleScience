...
- **Files Created**: 12 markdown files
- **Core Skills**: 6 specialized writing skills
- **Enhancement Plugins**: 4 tech doc plugins
...
└── skills/
    ├── reference-material/                      # Pre-stage: Reference reader
    ...
    ├── tech-doc-writing/                        # Tech doc orchestrator plugin
    ├── tech-doc-code-blocks/                    # Code block generation plugin
    ├── tech-doc-mermaid/                        # Mermaid diagram plugin
    └── tech-doc-image-search/                   # Image management plugin
```
...
4. **🔍 Review** (`reviewing-article/SKILL.md`)
   ...
   - Pass 3: Flow check
   - Pass 4: Polish
   - Pass 5: Technical Accuracy (tech docs only, via `tech-doc-writing` plugin)
   - Categorized issue tracking (critical/moderate/minor)

5. **🔧 Tech Doc Enhancement Plugins**
   - `tech-doc-writing` — Orchestrator: tech-specific brainstorming questions, 8 document-type templates, Technical Accuracy review pass
   - `tech-doc-code-blocks` — Code block generation with progressive complexity, syntax validation, formatting standards
   - `tech-doc-mermaid` — Mermaid diagram generation with type selection guide, syntax best practices
   - `tech-doc-image-search` — Image placeholder management, alt text generation, visual density guidelines
...
1. **reference-material/SKILL.md**
   - Scans docs/reference/ for txt, markdown, pdf, images
   - Extracts key themes, facts, quotes, visuals
   - Feeds context into all four writing stages

2. **brainstorming/SKILL.md** (5.4KB)
   - Question-driven topic exploration
   - Brief template and format
   - HARD-GATE enforcement

3. **writing-article-plan/SKILL.md** (5.6KB)
   - Section structure template
   - Research checklist
   - Style guidelines

4. **executing-article-plan/SKILL.md** (5.3KB)
   - Batch execution workflow
   - Self-check criteria
   - Checkpoint format

5. **subagent-driven-writing/SKILL.md** (7.8KB)
   - Subagent spawning instructions
   - Two-stage review process
   - Progress tracking

6. **reviewing-article/SKILL.md** (9.3KB)
   - Four-pass review methodology
   - Issue categorization system
   - Review log template

### Enhancement Plugin Files

6. **tech-doc-writing/SKILL.md**
   - IT tech doc orchestrator
   - 8 document-type templates (Tutorial, Architecture, API, Troubleshooting, Concept, Comparison, Best Practice, Release Note)
   - Tech-specific brainstorming questions and Pass 5 Technical Accuracy review

7. **tech-doc-code-blocks/SKILL.md**
   - Code block standards and formatting rules
   - Progressive complexity pattern (Minimal → Production → Advanced)
   - Code block type templates (shell, config, API, Dockerfile, diff)

8. **tech-doc-mermaid/SKILL.md**
   - Diagram type selection guide (flowchart, sequence, state, ER, timeline, git graph)
   - Mermaid syntax best practices and templates
   - Document-type-to-diagram mapping

9. **tech-doc-image-search/SKILL.md**
   - Image placeholder standards with IMAGE-TODO markers
   - Alt text guidelines for accessibility
   - Image source recommendations and visual density guidelines

## ✅ Quality Checklist

- [x] All six core skills implemented
- [x] All four tech doc enhancement plugins implemented
...
- [x] Document type templates (8 IT tech doc types — via tech-doc-writing plugin)
...
- [x] Reference material reading skill
